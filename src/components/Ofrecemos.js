            ...
            <div className="Container">
                <div className="ContainerTall">
                    <div className="ContainerSmall">
                        <img className="Img" src={camping} alt="Camping Laguna Milagros Huay Pix"/>
                        <div className="description">
                            <div>Acampada (Trae tu casa de campaña o renta una con nosotros).</div>
                            <div>Incluye una hora de kayak o bicicleta</div>
                            <div className="description-price">$100.00 MXN o $150.00 MXN</div>
                        </div>
                    </div>
                    <div className="ContainerSmall">
                        <img className="Img" src={daypass} alt="Muelle Laguna Milagros Huay Pix"/>
                        <div className="description">
                ...
                <div className="ContainerTall">
                    <div className="ContainerSmall">
                        <img className="Img" src={hielera} alt="Bebidas Cerveza Laguna Milagros Huay Pix"/>
                        <div className="description">
                            <div>Hielera (Acceso de bebidas propias). ¡Exclusivamente permitimos cervezas de la familia Corona y Modelo!</div>
                            <div className="description-price">$100.00 MXN</div>
                        </div>
                    </div>
                    <div className="ContainerSmall">
                        <img className="Img" src={kayak} alt="Renta Kayaks Laguna Milagros Huay Pix"/>
                        <div className="description">
                            <div>Renta de Kayaks (precio por hora)</div>
                            <div className="description-price">$60.00 MXN</div>
                        </div>
                    </div>
                </div>
                <div className="ContainerTall">
                    <div className="ContainerSmall">
                        <img className="Img" src={bici} alt="Renta Bicicletas Laguna Milagros Huay Pix"/>
                        <div className="description">
                    ...
                    <div className="ContainerSmall">
                        <img className="Img" src={Logo} alt="El Cenzontle Ecocamping Logo"/>
                        <div className="description">
                            <div>Renta de Paddle Surf (precio por hora)</div>
                            <div className="description-price">$120.00 MXN</div>
                        </div>
                    </div>
                </div>
            </div>
            <div style={{textAlign: "center", fontSize: "1.2em", fontWeight: "bold", paddingTop: "20px"}}>Instalaciones:</div>
